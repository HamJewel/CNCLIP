...
DATAPATH=E:/PythonProjects/CLIP/custom

# data options
train_data=${DATAPATH}/datasets/TipDM/lmdb/train
val_data=${DATAPATH}/datasets/TipDM/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=tipdm_finetune_vit-h-14_roberta-large_bs128_1gpu
